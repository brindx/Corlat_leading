...
/**
 * About Component - Corlat Logistics
 * Optimized for React 19 and Scroll Animations.
 */
export default function About() {
  ...
  useEffect(() => {
    // Sensor de visibilidad por scroll
  ...
  return (
    <section
      ref={sectionRef}
      className="py-20 md:py-32 bg-zinc-50 overflow-hidden"
      id="about"
    >
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-20 items-center">

          {/* Columna de Imagen: Entrada desde la izquierda (Scroll Revealed) */}
          <div className={`w-full lg:w-1/2 relative group transition-all duration-1000 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-12'}`}>
          ...
          {/* Columna de Texto: Entrada progresiva hacia arriba (Scroll Revealed) */}
          <div className={`w-full lg:w-1/2 space-y-8 mt-12 md:mt-0 transition-all duration-1000 delay-200 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`}>
            ...
            {/* Micro-animaciones en checklist */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-4">
              <div className={`space-y-2 transition-all duration-700 delay-500 ${isVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-95'}`}>
              ...
              <div className={`space-y-2 transition-all duration-700 delay-700 ${isVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-95'}`}>
                <div className="flex items-center gap-3 text-primary">
