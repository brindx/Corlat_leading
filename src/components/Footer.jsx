    ...
    <footer className="bg-zinc-950 text-white py-16 md:py-24 px-6 md:px-8 overflow-hidden font-body">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 lg:gap-16 mb-16">
          ...
          {/* Contact Direct */}
          <div className="space-y-6 text-center md:text-left">
            <h5 className="text-xl font-headline font-bold italic">Contacto Directo</h5>
            <div className="space-y-4">
              <div className="flex flex-col md:flex-row items-center gap-4 text-zinc-400">
                <PhoneIcon />
                <a href="tel:9931707640" className="font-headline font-bold text-white text-xl md:text-2xl hover:text-primary transition-colors tracking-tighter">993 170 7640</a>
              </div>
              ...
              <div className="flex flex-col md:flex-row items-center gap-4 text-zinc-400 text-sm font-bold">
                <LocationIcon />
                <p>Villahermosa / CDMX</p>
              </div>
            </div>
          </div>

          {/* Fast CTA */}
          <div className="bg-zinc-900 p-8 md:p-10 border-l-4 border-primary shadow-xl">
            <h5 className="text-xl font-headline font-bold mb-4 italic">¿Cotización hoy?</h5>
            <p className="text-zinc-400 text-sm font-bold mb-6 italic">Respondemos en menos de 10 min.</p>
            <a 
              className="bg-[#25D366] text-white w-full py-4 font-black flex items-center justify-center gap-2 hover:opacity-90 transition-all uppercase text-[10px] md:text-xs shadow-xl" 
              href={whatsappUrl}
            >
